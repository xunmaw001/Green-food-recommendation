...
public class LvseshipinCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LvseshipinCollectionEntity() {

	}

	public LvseshipinCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "lvseshipin_collection_types")
