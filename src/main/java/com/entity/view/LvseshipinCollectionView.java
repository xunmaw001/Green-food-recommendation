...
public class LvseshipinCollectionView extends LvseshipinCollectionEntity implements Serializable {
	...
	*/
	...
	private String lvseshipinCollectionValue;
	...
	public LvseshipinCollectionView() {

	}

	public LvseshipinCollectionView(LvseshipinCollectionEntity lvseshipinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, lvseshipinCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getLvseshipinCollectionValue() {
		return lvseshipinCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setLvseshipinCollectionValue(String lvseshipinCollectionValue) {
		this.lvseshipinCollectionValue = lvseshipinCollectionValue;
	}
	...
	public String toString() {
		return "LvseshipinCollectionView{" +
			", lvseshipinCollectionValue=" + lvseshipinCollectionValue +
