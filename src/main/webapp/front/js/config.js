...
var centerMenu = [
    ...
    ,{
        name: '绿色食品收藏',
        url: '../lvseshipinCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '绿色食品',
        url: './pages/lvseshipin/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/lvseshipintuijian/admin/dist/index.html#/login";
